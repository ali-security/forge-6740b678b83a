    ...
    if(obj.constructed === v.constructed ||
      ...
      if(v.value && forge.util.isArray(v.value)) {
        ...
        for(var i = 0; rval && i < v.value.length; ++i) {
          ...
          // If schema explicitly specifies tagClass/type, do a quick
          // structural check to avoid unnecessary recursion/side-effects
          // when tags clearly don't match.
          ...
          if(schemaHasTag &&
            ...
            // Tags do not match.
            if(schemaItem.optional) {
              // Skip this schema element (don't consume objChild; don't
          ...
          // Tags are compatible (or schema did not declare tags) - dive
          // into recursive validate.
          ...
          if(childRval) {
            ...
            // validation failed but element is optional => skip schema
            // item (don't consume child)
            rval = true;
          } else {
            // required item failed
            rval = false;
            // errors should already be populated by recursive call;
            // keep failing
            break;
          }
        }
